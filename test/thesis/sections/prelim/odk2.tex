...
% An innovative aspect of the \ODK project is that its preparation and management happens, as much as is practical and without infringing on privacy, in the open. For example, most documents, including the proposal itself, are version controlled on public repositories and progress on tasks and deliverables is tracked using public issues (see~\cite{OpenDreamKit:on}). This has proven a strong feature to collaborate tightly withthe community and get early feedback.
...
collaborative software development, and a package on data/knowledge/software-bases.\medskip
...
data, whilst taking provenance and citability into account. This package is the most relevant regarding
this thesis.
